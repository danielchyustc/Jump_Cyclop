...
local LGE       = require"levelGeneratorEasy"
...
function scene:create( event )
	...
	if levelDif[ln] == 1 then
		LGE.level1(sceneGroup,camera)
	elseif levelDif[ln] == 2 then
		LG.level1(sceneGroup,camera)
	end
	...
	tools.createBackground(camera,37)
end
